...
const GpioPin gpio_uart1_rx = {.type = GpioTypeHp, .pin = 29};
const GpioPin gpio_uart1_tx = {.type = GpioTypeHp, .pin = 30};
...
const GpioPin gpio_sw_busy = {.type = GpioTypeUlp, .pin = 2};
...
const GpioPin gpio_usart0_rx = {.type = GpioTypeUlp, .pin = 6};
const GpioPin gpio_usart0_tx = {.type = GpioTypeUlp, .pin = 7};
