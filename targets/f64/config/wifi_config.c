    ...
    .boot_config =
        {
            ...
            .feature_bit_map =
                (SL_SI91X_FEAT_SECURITY_OPEN | SL_SI91X_FEAT_SECURITY_PSK | BIT(19) | BIT(21) |
                 BIT(22) | SL_SI91X_FEAT_AGGREGATION | SL_SI91X_FEAT_ULP_GPIO_BASED_HANDSHAKE |
            ...
            .ext_custom_feature_bit_map =
                (SL_SI91X_EXT_FEAT_XTAL_CLK | SL_SI91X_EXT_FEAT_IEEE_80211W | MEMORY_CONFIG |
                 SL_SI91X_EXT_FEAT_UART_SEL_FOR_DEBUG_PRINTS | BIT(7)
#ifdef SLI_SI917
