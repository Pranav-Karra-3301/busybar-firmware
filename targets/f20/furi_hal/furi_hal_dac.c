...
void furi_hal_dac_init(void) {
    ...
    furi_hal_gpio_write(&gpio_dac_enable, 0);
    furi_hal_gpio_init(&gpio_dac_enable, GpioModeOutputPushPull, GpioPullNo, GpioSpeedLow);
}

void furi_hal_dac_pa_enable(void) {
    furi_hal_gpio_write(&gpio_dac_enable, 1);
    furi_delay_ms(10);
}
