 ...
 * Size: 8 px
 * Bpp: 1
 * Opts: --font /home/portasynthinca3/Downloads/Tiny5/Tiny5-Regular.ttf --bpp 1 --size 8 --no-compress --symbols ▶▹◃∞ --range 32-127,1040-1103 --format lvgl -o lib/lvgl_addons/fonts/lv_font_tiny5_8.c
 ******************************************************************************/
