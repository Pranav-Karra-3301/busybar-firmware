...
const char* data_rate_type[] = {"11Mbps",   "12Mbps",   "14.4Mbps", "17.2Mbps", "18Mbps",
                                "1Mbps",    "21.7Mbps", "24Mbps",   "25.8Mbps", "28.9Mbps",
                                "2Mbps",    "34.4Mbps", "36Mbps",   "43.3Mbps", "48Mbps",
                                "5.5Mbps",  "51.6Mbps", "54Mbps",   "57.8Mbps", "65Mbps",
                                "68.8Mbps", "6Mbps",    "7.2Mbps",  "72.2Mbps", "77.4Mbps",
                                "8.6Mbps",  "86Mbps",   "9Mbps",    "auto",     NULL};
const char* enable_bg_scan_type[] = {"bg_scan", NULL};
const char* flags_type[] = {"bind_and_listen", "connect", NULL};
const char* get_option_id_type[] =
    {"keepalivetimeout", "recvtimeout", "sendtimeout", "sockettype", NULL};
const char* ip_protocol_type[] = {"tcp", "udp", NULL};
const char* ipv4_or_ipv6_type[] = {"ipv4", "ipv6", NULL};
const char* net_interface_type[] =
    {"ap", "bluetooth", "client", "ethernet", "thread", "zwave", NULL};
const char* operating_band_type[] = {"2.4g", "5g", "dual", NULL};
const char* option_name_type[] = {
    "SO_CERT_INDEX",
    "SO_KEEPALIVE",
    ...
    "TCP_ULP",
    NULL};
const char* performance_mode_type[] = {
    "high_performance",
    "power_save",
...
const char* set_option_id_type[] =
    {"fionbio", "keepalivetimeout", "recvtimeout", "sendtimeout", NULL};
const char* sl_ip_address_type_t_type[] =
    {"ipv4", "ipv6", "ipv6_global", "ipv6_link_local", "ipv6_site_local", NULL};
...
const char* socket_protocol_type[] =
    {"ip_icmp", "ip_proto", "ip_raw", "ip_tcp", "ip_udp", "ip_udp_lite", NULL};
...
const char* wifi_encryption_type[] =
    {"ccmp", "fast", "open", "peap", "tkip", "tls", "ttls", "wep", NULL};
...
const value_list_t console_argument_values[] = {
    [CONSOLE_TYPE(ap_client_deauth)] =
        (const uint32_t[]){SL_WIFI_DEAUTH, SL_WIFI_DEAUTH_UNSPECIFIED},
    ...
    [CONSOLE_TYPE(data_rate)] =
        (const uint32_t[]){SL_WIFI_RATE_11B_11,    SL_WIFI_RATE_11G_12,    SL_WIFI_RATE_11N_MCS1,
                           SL_WIFI_RATE_11AX_MCS1, SL_WIFI_RATE_11G_18,    SL_WIFI_RATE_11B_1,
                           SL_WIFI_RATE_11N_MCS2,  SL_WIFI_RATE_11G_24,    SL_WIFI_RATE_11AX_MCS2,
                           SL_WIFI_RATE_11N_MCS3,  SL_WIFI_RATE_11B_2,     SL_WIFI_RATE_11AX_MCS3,
                           SL_WIFI_RATE_11G_36,    SL_WIFI_RATE_11N_MCS4,  SL_WIFI_RATE_11G_48,
                           SL_WIFI_RATE_11B_5_5,   SL_WIFI_RATE_11AX_MCS4, SL_WIFI_RATE_11G_54,
                           SL_WIFI_RATE_11N_MCS5,  SL_WIFI_RATE_11N_MCS6,  SL_WIFI_RATE_11AX_MCS5,
                           SL_WIFI_RATE_11G_6,     SL_WIFI_RATE_11N_MCS0,  SL_WIFI_RATE_11N_MCS7,
                           SL_WIFI_RATE_11AX_MCS6, SL_WIFI_RATE_11AX_MCS0, SL_WIFI_RATE_11AX_MCS7,
                           SL_WIFI_RATE_11G_9,     SL_WIFI_AUTO_RATE},
    ...
    [CONSOLE_TYPE(ip_protocol)] =
        (const uint32_t[]){IOT_SOCKET_IPPROTO_TCP, IOT_SOCKET_IPPROTO_UDP},
    ...
    [CONSOLE_TYPE(sl_ip_management_t)] =
        (const uint32_t[]){SL_IP_MANAGEMENT_DHCP, SL_IP_MANAGEMENT_STATIC_IP},
    [CONSOLE_TYPE(sl_net_dns_resolution_ip_type_t)] =
        (const uint32_t[]){SL_NET_DNS_TYPE_IPV4, SL_NET_DNS_TYPE_IPV6},
    ...
    [CONSOLE_TYPE(socket_type)] =
        (const uint32_t[]){IOT_SOCKET_SOCK_DGRAM, IOT_SOCKET_SOCK_STREAM},
    ...
    [CONSOLE_TYPE(wps_mode)] =
        (const uint32_t[]){SL_WIFI_WPS_PIN_MODE, SL_WIFI_WPS_PUSH_BUTTON_MODE},
};
