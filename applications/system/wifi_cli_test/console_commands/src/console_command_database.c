...
static const console_descriptive_command_t _get_command = {
    .description = "Get",
...
static const console_descriptive_command_t _help_command = {
...
static const console_descriptive_command_t _list_command = {
...
static const console_descriptive_command_t _net_deinit_command = {
    .description = "Deinit the network interface",
    .argument_help = _net_deinit_arg_help,
    .handler = net_deinit_command_handler,
    .argument_list = {CONSOLE_ENUM_ARG(net_interface), CONSOLE_ARG_END}};
...
static const console_descriptive_command_t _net_down_command = {
...
static const console_descriptive_command_t _net_init_command = {
...
static const console_descriptive_command_t _net_join_multicast_address_command = {
    ...
    .argument_list = {
        CONSOLE_OPTIONAL_ARG('i', CONSOLE_ENUM_ARG(net_interface)),
...
static const console_descriptive_command_t _net_up_command = {
    ...
    .argument_list = {
        CONSOLE_ENUM_ARG(net_interface),
...
static const console_descriptive_command_t _rtt_command = {
...
static const console_descriptive_command_t _sl_net_ping_command = {
    ...
    .argument_list = {
        CONSOLE_ARG_STRING,
        CONSOLE_ENUM_ARG(sl_ip_address_type_t),
        CONSOLE_ARG_UINT,
        CONSOLE_ARG_END}};
...
static const console_descriptive_command_t _start_dhcp_command = {
    ...
    .argument_list = {
        CONSOLE_OPTIONAL_ARG('i', CONSOLE_ENUM_ARG(sl_ip_address_type_t)),
...
static const console_descriptive_command_t _wifi_assert_command = {
...
static const console_descriptive_command_t _wifi_bsd_socket_bind_command = {
    ...
    .argument_list =
        {CONSOLE_ARG_INT, CONSOLE_ARG_STRING, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_END}};
...
static const console_descriptive_command_t _wifi_deinit_command = {
...
extern sl_status_t
    sl_wifi_get_advanced_scan_configuration_command_handler(console_args_t* arguments);
...
static const console_descriptive_command_t _wifi_get_tx_power_command = {
...
static const console_descriptive_command_t _wifi_init_command = {
    ...
    .argument_list = {
        CONSOLE_OPTIONAL_ARG('i', CONSOLE_ENUM_ARG(wifi_init_mode)),
        CONSOLE_ARG_END}};
...
static const console_descriptive_command_t _wifi_iot_socket_set_opt_command = {
    .description =
        "IOT socket set opt parameters are \n 1 - sock_fd \n 2 - option_id \n 3 - value \n",
    .argument_help = _wifi_iot_socket_set_opt_arg_help,
    .handler = wifi_iot_socket_set_opt_handler,
    .argument_list =
        {CONSOLE_ARG_INT, CONSOLE_ENUM_ARG(set_option_id), CONSOLE_ARG_INT, CONSOLE_ARG_END}};
...
static const console_descriptive_command_t _wifi_load_certificate_command = {
    ...
    .argument_list = {
        CONSOLE_OPTIONAL_ARG('l', CONSOLE_ARG_INT),
...
extern sl_status_t
    sl_wifi_set_advanced_scan_configuration_command_handler(console_args_t* arguments);
...
static const console_descriptive_command_t _wifi_set_ap_configuration_command = {
    .description =
        "set ap configuration -s ssid -c channel -o option -i credential_id -t client_timeout -d becon_count "
        "-m max_clients",
...
static const console_descriptive_command_t _wifi_set_transmit_rate_command = {
    ...
    .argument_list = {
        CONSOLE_ENUM_ARG(rate_protocol),
...
static const console_descriptive_command_t _wifi_ax_transmit_test_start_command = {
    ...
    .argument_list = {CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT,
                      CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT,
                      CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT,
                      CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT,
                      CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT,
                      CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT,
